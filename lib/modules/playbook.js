...
class Playbook {
  ...
  */
  transcribe (instance, ...args) {
    ...
    if (!instance) transcript.recordAll()
    else if (instance instanceof this.Dialogue) transcript.recordDialogue(instance)
    else if (instance instanceof this.Scene) transcript.recordScene(instance)
    else if (instance instanceof this.Director) transcript.recordDirector(instance)
    return transcript
  }
